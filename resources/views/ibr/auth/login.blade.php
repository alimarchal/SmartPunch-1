            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('ibr.login') }}">
                            @csrf
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p><a href="{{ route('ibr.forgotPassword') }}" class=" text-info ml-1"><i class="fa fa-lock mr-1"></i>{{__('login.Forgot your password?')}}</a></p>
                        <p class="text-white">{{__('login.Don\'t have an account?')}} <a href="{{route('ibr.register')}}" class="text-dark ml-1"><b style="color: #2890f6">{{__('login.Sign Up')}}</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
